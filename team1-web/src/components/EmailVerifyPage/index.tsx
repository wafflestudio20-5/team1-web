  ...
  return (
    <article className={styles['email-verify-page']}>
      <div className={styles['card']}>
        ...
        <section className={styles['input-conatiner']}>
          <h2>이메일 주소 입력</h2>
        ...
        <section className={styles['agreements']}>
          ...
          <div className={styles['agreement']}>
            <input type='checkbox' />
            <label className={styles['text']}>재학생 인증 이용 동의(필수)</label>
            <ul>
              <li>
          ...
          <div className={styles['agreement']}>
            ...
            <ul>
              <li>수집된 개인정보는 개인정보 처리방침에 따라 안전하게 처리됩니다.</li>
              <li>재학생 확인 절차를 위해 이메일 주소를 수집합니다.</li>
            </ul>
          </div>
        </section>
      </div>
